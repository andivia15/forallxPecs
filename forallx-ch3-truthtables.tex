...
Az egész állítás feltételes \script{A}\eif\script{B}-vel  $(P \eand Q)$ mint \script{A}, és $P$-vel mint \script{B}.
A második sorban, például $(P\eand Q)$ hamis és  $P$ igaz.
Mivel egy feltétel igaz, ha az előzmény hamis, akkor egy 1-est írunk a második sorba a feltételes szimbólum alá.
...
\begin{earg}
\item Tegyük fel, hogy \script{A} és \script{B} logikailag ekvivalensek. Ebben az esetben mit lehet elmondani $\script{A}\eiff\script{B}$?
\item Tegyük fel, hogy $(\script{A}\eand\script{B})\eif\script{C}$ kontingens. Mit tudsz elmondani az ``\script{A}, \script{B}, \therefore\script{C}'' argumentumról?
...
\item Tegyük fel, hogy \script{A} egy kontradikció. Mit tudsz elmondani ``\script{A}, \script{B}, \therefore\script{C}'' argumentumról?
\item Tegyük fel, hogy \script{C} tautológia. Ebben az esetben mit lehet elmondani ``\script{A}, \script{B}, \therefore\script{C}'' argumentumról?
\item Tegyük fel, hogy \script{A} és \script{B} logikailag ekvivalensek. Mit tudsz elmondani $(\script{A}\eor\script{B})$-ről?
\item Tegyük fel, hogy \script{A} és \script{B} \emph{nem} logikailag ekvivalensek. Mit tudsz elmondani $(\script{A}\eor\script{B})$-ről?
\end{earg}
...
A \emph{Sheffer-funktor} (negált konjunkció) egy logikai művelet, a következő igazságtáblával:
\begin{center}
\begin{tabular}{c|c|c}
